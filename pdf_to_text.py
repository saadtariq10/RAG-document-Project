...
if platform.system() == "Windows":
	...
	path_to_poppler_exe = Path(r"C:\poppler\Library\bin")
	
	# Put our output files in a sane place...
	out_directory = Path(__file__).parent  # This sets the output directory to the script's location
...
PDF_file = Path(r"scanned_pdf.pdf")

# Store all the pages of the PDF in a variable
image_file_list = []

text_file = out_directory / "out_text.txt"
